...
Канонический набор эмоций (10): дружелюбный, думает, идея, решение, успех, удивление, внимание, работа, аналитика, консультация. Эмоция передаётся выражением лица-дисплея и позой — образ персонажа при этом не меняется. Негативные эмоции как основной образ не используем.

## Жесты

Допустимые жесты: открытая ладонь (приветствие), указание, OK / согласие, держит планшет. Жесты — дружелюбные и рабочие, без агрессии.

## Масштабирование

Персонаж сохраняет узнаваемость в размерах **S / M / L / XL**: на маленьких размерах убираем мелкие детали корпуса, оставляя силуэт, голову и глаза. Пропорции (крупная голова, компактное тело) не меняем ни на одном размере.
