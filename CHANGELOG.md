...
- Шаблон КП: `templates/documents/kp-template.docx` (+ .pdf превью) — пустая брендированная «рыба» с placeholder'ами, без данных клиента и реквизитов; собран генератором dicom-kp.
